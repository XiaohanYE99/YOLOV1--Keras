...
def build_detector(predicts,threshold=0.2,iou_threshold=0.4,max_output_size=10):
		...
		#print(tf.Session().run(class_probs))
		#print(tf.Session().run(confs))
...
if __name__ == '__main__':
    detect_from_file('./image_0636.jpg',imshow=True,detected_image_file="test_image1.jpg")
